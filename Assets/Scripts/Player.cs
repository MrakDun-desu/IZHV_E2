...
public class Player : MonoBehaviour
{
    ...
    /// </summary>
    [Range(0, 3)] public float jumpVelocity = 1.0f;

    /// <summary>
    /// Distance to which ground should be detected.
    /// </summary>
    [Range(0, 1)] public float groundCheckDistance = 0.01f;
    ...
    /// </summary>
    public bool3 rotateAxis = new(true, false, false);

    /// <summary>
    /// Direction of rotation for each axis.
    /// </summary>
    public float3 axisDirection = new(1.0f, 1.0f, 1.0f);
    ...
    private void Update()
    {
        ...
        if (verticalMovement == 0.0 || mSwitchedGravity) return;
    ...
    /// <summary>
    /// Update called for every fixed update interval.
    /// </summary>
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        if (!hitObstacle) return; // If we collide with any obstacle -> end the game.
        // Update the sprite.
